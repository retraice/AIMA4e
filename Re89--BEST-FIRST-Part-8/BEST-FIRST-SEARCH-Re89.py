...
################################################################################
# run Re89; t stands for test                              
tlinks = {('A', 'Z'): 75, ('A', 'S'): 140, ('A', 'T'): 118,
          ('Yo', 'Momma'): 90, ('Momma', 'Dadda'): 91}
# tlinksNoDistances = {('A', 'Z'), ('A', 'S'), ('A', 'T')}
tlocations = {'A': ( 76, 497), 'S': (187, 463),
              'T': ( 83, 414), 'Z': (92, 539)}
...
# Showing dict vs defaultdict in iPython: 
# In [5]: print(dict())
# {}

# In [6]: print(defaultdict())
# defaultdict(None, {})

# In [7]: print(defaultdict(list))
